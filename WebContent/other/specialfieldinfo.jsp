		...
		<div class="row">
			...
			<div class="col-sm-10">
				<ol class="breadcrumb">
					...
					<li class="active">专业信息管理</li>
				</ol>

				<div class="panel panel-default">
					<div class="panel-heading">搜索</div>
					<div class="panel-body">
						<form role="form" id="subform" class="form-inline" method="post"
							action="${pageContext.request.contextPath}/findSpecialFieldInfo.action">
							<div class="form-group">
								<label for="name">名称</label> <input type="text" value="${param.name}"
							...
							<div class="form-group" style="margin-left: 50px;">
								<button type="button" class="btn btn-info" data-toggle="modal"
									data-target="#myModal">添加专业信息</button>
							</div>
						</form>
					</div>
				</div>
							...
							<c:forEach items="${page.rows}" var="c" varStatus="status">
								<tr>
									...
									<td>
										<div class="btn-group">
											<a
												href="${pageContext.request.contextPath}/showSpecialFieldInfo.action?id=${c.id}"
												class="btn btn-success">查看</a> <a
												href="${pageContext.request.contextPath}/deleteSpecialFieldInfo.action?id=${c.id}"
				...
				<div class="col-sm-12 text-right">
					<wt:page
						url="${pageContext.request.contextPath}/findSpecialFieldInfo.action"></wt:page>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">添加专业信息</h4>
				</div>
				<form method="post"
					action="${pageContext.request.contextPath}/addSpecialFieldInfo.action"
					id="specialForm">
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-sm-6">
								...
								<div class="form-group">
									<label for="name">所属院系</label> <input type="text"
										class="form-control" id="collegeid" name="collegeid" placeholder="学院名称">
								</div>
								<div class="form-group">
