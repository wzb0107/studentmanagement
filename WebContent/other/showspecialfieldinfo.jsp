				...
				<div class="row">
					...
					<div class="col-sm-4">
						<form method="post" id="specialForm"
							action="${pageContext.request.contextPath}/updateSpecialInfo.action">
							<div class="form-group">
								<input type="hidden" id="id" name="id" value="${specialFieldInfo.id}">
								<label for="number">专业编号</label> <input type="text"
									class="form-control" id="number" value="${specialFieldInfo.number}"
									name="number" placeholder="专业编号">
							</div>
							<div class="form-group">
								<label for="name">专业名称</label> <input type="text"
									value="${specialFieldInfo.name}" class="form-control" id="name"
									name="name" placeholder="专业名称">
							</div>
							<div class="form-group">
								<label for="name">学院ID</label> <input type="text"
									value="${specialFieldInfo.collegeid}" class="form-control" id="collegeid"
									name="collegeid" placeholder="学院ID">
							</div>
							<div class="form-group">
								<label for="birthday">开专业时间</label> <input type="text"
									value="<fmt:formatDate value="${specialFieldInfo.birthday}"
											pattern="yyyy-MM-dd" />"
							...
							<div class="form-group">
								<label for="man">负责人</label> <input type="text"
									value="${specialFieldInfo.man}" class="form-control" id="man"
									name="man" placeholder="负责人">
							</div>
							<div class="form-group">
								<label for="phone">手机</label> <input type="text"
									value="${specialFieldInfo.phone}" class="form-control" id="phone"
									name="phone" placeholder="手机">
							</div>
							<div class="form-group">
								<label for="memo">附加信息</label>
								<textarea class="form-control" rows="3"
									placeholder="不要超过200字..." name="memo">${specialFieldInfo.memo}</textarea>
							</div>
							<div class="form-group" style="margin-left: 50px;">
								<input type="submit" class="btn btn-info" value="修改专业信息">
								<a href="${pageContext.request.contextPath}/other/specialfieldinfo.jsp" class="btn btn-info" style="margin-left:60px">返回</a>
							</div>
						</form>
					</div>
					<div class="col-sm-4"></div>
