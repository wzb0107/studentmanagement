		...
		<div class="container-fluid">
            <div class="row">
                <div class="col-sm-2">
                    ...
                    <a href="${pageContext.request.contextPath}/findTeacher.action" class="list-group-item active">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form role="form" class="form-inline" method="post" action="${pageContext.request.contextPath}/findTeacher.action" enctype="multipart/form-data">
                                ...
                                <div class="form-group" style="margin-left: 50px;">
									...
									data-target="#myModal">添加教师信息</button>
                                </div>
                            </form>
                        </div>
                    </div>
                            ...
                            <tbody>
                            	<c:forEach items="${page.rows}" var="c" varStatus="status">
	                                <tr>
	                                    ...
	                                    <td><fmt:formatDate value="${c.arrivedate}"
											pattern="yyyy-MM-dd" /></td>
	                                    <td>${c.cardnumber}</td>
	                                    <td>${c.phone}</td>
	                                    <td>
	                                        <div class="btn-group">
	                                            <a href="${pageContext.request.contextPath}/showTeacher.action?id=${c.id}" class="btn btn-success">查看</a>
	                                            <a href="${pageContext.request.contextPath}/deleteTeacher.action?id=${c.id}" class="btn btn-danger">删除</a>
	                                        </div>
	                                    </td>
	                                </tr>
                                </c:forEach>
				    ...
				    <div class="col-sm-12 text-right">
						<wt:page
							url="${pageContext.request.contextPath}/findTeacher.action"></wt:page>
					</div>                  
                </div>
            </div>
        </div>
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form method="post"
					action="${pageContext.request.contextPath}/addTeacher.action" enctype="multipart/form-data"
					id="teacherForm" >
							...
							<div class="col-sm-6">
								...
								<div class="form-group">
									<label for="address">家庭住址</label> <input type="text"
										class="form-control" id="address" name="address" placeholder="家庭住址">
								</div>
								<div class="form-group">
